...
u32 Set(u8 Object, u32 Value)
{
  ...
  case FPGA_RST:    GPIOB_CRH &= 0xF0FFFFFF;  GPIOB_CRH |= 0x01000000;        // 设PB14为输出状态//Set the PB14 output Mode
                    ...
                    GPIOB_CRH &= 0xF0FFFFFF;  GPIOB_CRH |= 0x08000000; break; // 设PB14为输入状态 //Set the PB14 input Mode
...
u32 Get(u8 Object, u32 Value)
{
  ...
  case VERTICAL:    return (u32)Y_ATTR;              // 垂直通道属性指针//Pointer to vertical attribution
    
  case HORIZONTAL:  return (u32)X_ATTR;              // 水平通道属性指针//Pointer to horizontal attribution
    
  case GLOBAL:      return (u32)G_ATTR;              // 整体属性指针//Pointer to hardware global attribution
  
    
  case TRIGGER:     return (u32)T_ATTR;              // 触发通道属性指针//Pointer to trigger attribution
